...
AppConfig conf {
    ...
    .MQTT_PING_TOPIC = FROM_ENV(APP_MQTT_PING_TOPIC),
    .MQTT_REQUEST_TOPIC = FROM_ENV(APP_MQTT_REQUEST_TOPIC),
    .MQTT_CAPTURE_TOPIC = FROM_ENV(APP_MQTT_CAPTURE_TOPIC),
    .MQTT_PUBLISH_PONG_TOPIC = FROM_ENV(APP_MQTT_PUBLISH_PONG_TOPIC),
