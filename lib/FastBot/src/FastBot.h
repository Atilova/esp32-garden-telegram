...
//! Custom callback, to support std::bind, instead
//! Orignal: void(*_callback)(FB_msg& msg)
#define SMART_CALLBACK std::function<void(FB_msg& msg)> _callback
