...
#define _BUILD_SIGNATURE std::function<void(void)> _build
#define _BUILD_R_SIGNATURE std::function<void(GyverPortal&)> _buildR

#define _ACTION_SIGNATURE std::function<void(void)> _action
#define _ACTION_R_SIGNATURE std::function<void(GyverPortal& p)> _actionR
...
public:
    ...
    void attachBuild(_BUILD_SIGNATURE) {
        this->_build = _build;
    }

    // void attachBuild(_BUILD_R_SIGNATURE) {
    //     this->_buildR = _buildR;
    // }
